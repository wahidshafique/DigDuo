...
//             name: String, state: EntityState, restoreFrame: Bool = false, reversing: Bool = false)
//        {
...
//        let action: SKAction
//        let name: String
//        let associatedState: EntityState
...
//     */
//    func addAnimation(name: String, associatedState: EntityState = .none, timePerFrame: TimeInterval,
...
//            let animation = Animation.init(textures: textureList, timePerFrame: timePerFrame,
//                                           name: name, state: associatedState, restoreFrame: holdLastFrame, reversing: reversing)
